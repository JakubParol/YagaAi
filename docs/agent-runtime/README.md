...
2. [00a-agreed-requirements.md](00a-agreed-requirements.md) — frozen baseline requirements and constraints
3. [01-system-overview.md](01-system-overview.md) — high-level mental model
4. [02-core-model.md](02-core-model.md) — core entities and their relationships

**Communication and routing:**

5. [03-runtime-and-a2a.md](03-runtime-and-a2a.md) — message types, A2A contracts
6. [04-channel-sessions-and-main-owner-routing.md](04-channel-sessions-and-main-owner-routing.md) — ingress topology, normalization contract
7. [05-ownership-lifecycle-and-state.md](05-ownership-lifecycle-and-state.md) — ownership rules, task lifecycle

**How agents work internally:**

8. [06-internal-prompt-architecture.md](06-internal-prompt-architecture.md) — prompt layering, runtime enforcement, skills
9. [07-memory-model-and-vectorization.md](07-memory-model-and-vectorization.md) — memory layers, retrieval planes, vectorization

**Operations and flows:**

10. [08-mission-control-model.md](08-mission-control-model.md) — MC as the first planning/control-plane integration
11. [09-operational-flows.md](09-operational-flows.md) — end-to-end flows for research, implementation, QA
12. [10-failure-recovery-and-timeouts.md](10-failure-recovery-and-timeouts.md) — failure modes, recovery paths, timeouts
13. [11-observability-and-audit.md](11-observability-and-audit.md) — request/task observability, audit trail, replay

**Governance and implementation:**

14. [12-governance-and-v1-boundaries.md](12-governance-and-v1-boundaries.md) — v1 scope, non-goals, control points
15. [13-implementation-decisions.md](13-implementation-decisions.md) — blocking implementation choices for request/routing/publication
16. [14-hld-runtime-shape-and-installation.md](14-hld-runtime-shape-and-installation.md) — runtime shape, deployment patterns
17. [15-tech-stack.md](15-tech-stack.md) — concrete technology choices with rationale
...
| [00a-agreed-requirements.md](00a-agreed-requirements.md) | Frozen product requirements and architectural constraints agreed before further doc refinement |
