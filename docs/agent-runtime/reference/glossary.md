...
routing metadata, strategic owner metadata, reply-target metadata, and publication state.
Callback delivery metadata lives on task/handoff and callback event paths.
